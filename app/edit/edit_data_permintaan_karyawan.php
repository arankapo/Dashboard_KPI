...
<script src="assets/js/jquery.js"></script>
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
			<form method="get" action="edit/update_data_permintaan.php">
              <div class="card">
              <div class="card-header">
                <h3 class="text-center"><img src="image/mse.png">  PT. MEGA SURYA ERATAMA1</h3> 
              </div>
			...
			<div class="row">
				...
				<div class="col-sm-4">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" value="<?php echo $view['tanggal_pemenuhan'];?>">
                    </div>
                  </div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-sm-4">
                    ...
                    <div class="col-sm-7">
						<input type="text" class="form-control" value="<?php echo $view['nama_dept'];?>">
                    </div>
                  </div>
				</div>
				<div class="col-sm-3"></div>
				<div class="col-sm-4">
                    ...
                    <label for="inputEmail3" class="col-sm-5	 col-form-label"> Penempatan :</label>
                     <div class="col-sm-7">
                      <input type="text" name="penempatan" id="penempatan" class="form-control"  value="<?php echo $view['penempatan'];?>">
                    </div>
                  </div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-sm-4">
                    ...
                    <div class="col-sm-7">
                      <input type="text" name="klasifikasi" id="klasifikasi" class="form-control"  value="<?php echo $view['klasifikasi'];?>">
                    </div>
                  </div>
				</div>
				<div class="col-sm-3"></div>
				<div class="col-sm-4">
                    ...
                    <label for="inputEmail3" class="col-sm-5	 col-form-label"> Jumlah</label>
                     <div class="col-sm-7">
                     <input type="text" name="jumlah" id="jumlah" class="form-control" value="<?php echo $view['jumlah'];?>">
                    </div>
                  </div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-sm-4">
                    ...
                    <div class="col-sm-7">
                     <input type="text" name="jabatan" id="jabatan" class="form-control"  value="<?php echo $view['jabatan'];?>">
                    </div>
                  </div>
				</div>
				<div class="col-sm-3"></div>
				<div class="col-sm-4">
                    ...
                    <div class="col-sm-7">
                     <input type="text" name="status_karyawan" id="status_karyawan" class="form-control"  value="<?php echo $view['status_karyawan'];?>">
                    </div>
                  </div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="form-group row">
                    ...
                    <div class="col-sm-7">
                     <input type="text" name="jenis_kelamin" id="jenis_kelamin" class="form-control"  value="<?php echo $view['jenis_kelamin'];?>">
                    </div>
                  </div>
				</div>
				<div class="col-sm-3"></div>
				<div class="col-sm-4">
					<div class="form-group row">
                    <label for="inputEmail3" class="col-sm-5	 col-form-label"> Jam Kerja :</label>
                    <div class="col-sm-7">
                     <input type="text" name="jam_kerja" id="jam_kerja" class="form-control"  value="<?php echo $view['jam_kerja'];?>">
                    </div>
                  </div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-sm-4">
                    ...
                    <div class="col-sm-7">
                     <input type="text" name="pendidikan_minimum" id="pendidikan_minimum" class="form-control"  value="<?php echo $view['pendidikan_minimum'];?>">
                    </div>
                  </div>
				</div>
				<div class="col-sm-3"></div>
				<div class="col-sm-4">
                    ...
                    <div class="col-sm-7">
                      <input type="text" name="jurusan" id="jurusan" class="form-control"  value="<?php echo $view['jurusan'];?>">
                    </div>
                  </div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-sm-4">
                    ...
                    <div class="col-sm-7">
						<input type="text" name="usia" id="usia" class="form-control"  value="<?php echo $view['usia'];?>">
                    </div>
                  </div>
				</div>
				<div class="col-sm-3"></div>
				<div class="col-sm-4">
                    ...
                    <div class="col-sm-7">
                     <input type="text" name="pengalaman" id="pengalaman" class="form-control"  value="<?php echo $view['pengalaman'];?>">
                    </div>
                  </div>
			</div>
				</div>
			...
			<div class="row">
				<div class="col-sm-12">
					  <div class="col-sm-12">
                      <input type="text" name="alasan" id="alasan" class="form-control"  value="<?php echo $view['alasan'];?>"></textarea>
                    </div>
				</div>
			</div>			  
			...
			<div class="row">
				<div class="col-sm-12">
					  <div class="col-sm-12">
                      <input type="text" name="job_desk" id="job_desk" class="form-control"  value="<?php echo $view['job_desk'];?>"></textarea>
                    </div>
				</div>
			</div>			  
