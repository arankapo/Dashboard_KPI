...
<script src="assets/js/jquery.js"></script>
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
			<form method="get" action="edit/update_tanggal_approve.php">
              <div class="card">
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="form-group row">
                    <label for="inputEmail3" class="col-sm-5	 col-form-label"> Tanggal Approve :</label>
                    <div class="col-sm-7">
                      <input type="date" class="form-control" placeholder="Tanggal Pemenuhan " name="tanggal_approve" value="<?php echo date('Y-m-d'); ?>">
                    </div>
                  </div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="form-group row">
                    <label for="inputEmail3" class="col-sm-5	 col-form-label"> Jumlah Pengajuan :</label>
                     <div class="col-sm-7">
                      <input type="text" class="form-control" Readonly value="<?php echo $view['jumlah'];?>">
                    </div>
                  </div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-sm-4">
                    ...
                    <label for="inputEmail3" class="col-sm-5	 col-form-label"> Jumlah Approve</label>
                     <div class="col-sm-7">
                     <input type="text" name="jumlah_approve" id="jumlah_approve" class="form-control">
                    </div>
                  </div>
				</div>
			</div>
